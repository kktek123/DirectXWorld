...
void DSpotLightDemo::Initialize()
{
...
void DSpotLightDemo::Destroy()
{

}

void DSpotLightDemo::Update()
{
	sky->Update();
...
void DSpotLightDemo::PostRender()
{
	gBuffer->PostRender();
}

void DSpotLightDemo::Mesh()
{
	//Create Material
	{
...
void DSpotLightDemo::Pass(UINT mesh, UINT model, UINT anim)
{
...
void DSpotLightDemo::AddPointLights()
{
	PointLight light;
	light =
	{
...
void DSpotLightDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
