...
void RefractionDemo::Initialize()
{
	...
	refraction = new Refraction(shader, L"Environment/Wave.dds");

	plane = new MeshRender(shader, new MeshGrid(5, 5));
	Transform* transform = plane->AddTransform();
	transform->Position(0, 5, 0);
	transform->Scale(9.0f, 1, 9.0f);
...
void RefractionDemo::AddPointLights()
{
	PointLight light;
	light =
	{
...
void RefractionDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
