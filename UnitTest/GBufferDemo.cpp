...
void GBufferDemo::Initialize()
{
	...
	shader = new Shader(L"49_Deffered.fxo");	
...
void GBufferDemo::Destroy()
{

}

void GBufferDemo::Update()
{
	sky->Update();
...
void GBufferDemo::PostRender()
{
	gBuffer->PostRender();
}

void GBufferDemo::Mesh()
{
	//Create Material
	{
...
void GBufferDemo::Pass(UINT mesh, UINT model, UINT anim)
{
...
void GBufferDemo::AddPointLights()
{
	PointLight light;
	light =
	{
...
void GBufferDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
