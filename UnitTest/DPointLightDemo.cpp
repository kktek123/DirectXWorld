...
void DPointLightDemo::Initialize()
{
	...
	shader = new Shader(L"50_PointLight.fxo");	
...
void DPointLightDemo::Destroy()
{

}

void DPointLightDemo::Update()
{
	sky->Update();
...
void DPointLightDemo::PreRender()
{
	//PackGBuffer
	{
		gBuffer->PreRender();
...
void DPointLightDemo::PostRender()
{
	gBuffer->PostRender();
}

void DPointLightDemo::Mesh()
{
	//Create Material
	{
...
void DPointLightDemo::Pass(UINT mesh, UINT model, UINT anim)
{
...
void DPointLightDemo::AddPointLights()
{
	PointLight light;
	light =
	{
...
void DPointLightDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
